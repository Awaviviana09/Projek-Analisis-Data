...
def sidebar(df):
    ...
    with st.sidebar:
        # Menambahkan ikon dan gambar di sidebar
        image_path = "images/logo21.gif"
        if os.path.exists(image_path):
            st.image(image_path, caption="Eksplorasi Pembagian Sepeda", use_column_width=True)
        else:
            st.error("Gambar logo tidak ditemukan!")
...
if __name__ == "__main__":
    ...
    # Membuat tampilan background gradasi abu-abu
    st.markdown(
        """
        <style>
